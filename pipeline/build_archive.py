    ...
    <div class="cols">
      <div>
        ...
        <p>Every song, air date and episode number was read straight out of the wikitext of the
          ...
          article declares. One morning, November 1, 2019, is listed as N/A, so it carries no
          entry here. She did sing that day: five shortened songs of her own, <i>Miss
          Independent</i>, <i>Walk Away</i>, <i>Since U Been Gone</i>, <i>Stronger</i> and
          <i>Invincible</i>, before announcing her <i>Invincible</i> Las Vegas residency. Not one
          of them was a cover, which is the likeliest reason the column is blank.</p>
